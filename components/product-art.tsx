...
export function ProductArt({ art, accent, compact = false, label }: ProductArtProps) {
  return (
    <div className={`product-art product-art-${art} ${compact ? "product-art-compact" : ""}`} style={{ "--art-accent": accent } as CSSProperties}>
      <span className="art-grid" />
      <span className="art-index">{label ?? "NØR / 01"}</span>
      <svg aria-hidden="true" className="art-object" fill="none" viewBox="0 0 420 330">
        {art === "board" && <BoardArt />}
...
function BoardArt() {
  return <g className="board-object">
    ...
    <circle cx="307" cy="107" r="15" /><circle cx="307" cy="107" r="5" />
...
function SensorArt() {
  return <g className="sensor-object">
    ...
    <circle cx="209" cy="126" r="9" /><circle cx="209" cy="148" r="9" />
    <path className="art-accent-stroke" d="M172 80 178 68M194 70V56M218 68l5-14M242 76l8-11" />
    <path d="M123 125H92M125 153H87M291 133h40M291 163h31M151 224l-11 24M275 217l12 26" />
  </g>;
}

function PowerArt() {
  return <g className="power-object">
...
function ToolsArt() {
  return <g className="tools-object">
    ...
    <path className="art-accent-stroke" d="m218 91 30-28M246 63l23 12-21 17" />
    <rect height="37" rx="7" transform="rotate(38 298 184)" width="75" x="260" y="165" />
    <path d="m295 174 30 23M283 190l30 23M272 205l29 23" />
  </g>;
}

function ModuleArt() {
  return <g className="module-object">
    ...
    <circle className="art-accent-fill" cx="118" cy="158" r="8" /><circle className="art-accent-fill" cx="302" cy="158" r="8" />
    <path className="art-accent-stroke" d="M142 158h28M250 158h28M210 114v12M210 198v20" />
  </g>;
}

function DisplayArt() {
  return <g className="display-object">
    <rect height="156" rx="10" width="268" x="76" y="84" />
    <rect className="screen-fill" height="102" rx="4" width="202" x="109" y="111" />
    <path className="screen-line" d="M126 170h76l18-22 23 12 18-31M126 190h52M126 132h48" />
    <path d="M161 240v38M259 240v38M139 278h143" />
    <path className="art-accent-stroke" d="M93 116h-21M93 138h-21M93 160h-21M327 116h21M327 138h21M327 160h21" />
  </g>;
}
